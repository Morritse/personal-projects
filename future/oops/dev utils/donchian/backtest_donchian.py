...
from config import DONCHIAN_STRATEGY
...
def analyze_instrument(df, strategy, symbol):
...
def main():
    ...
    strategy = DonchianStrategy(**DONCHIAN_STRATEGY)
    print("\nRunning Donchian Channel Strategy...")
    
    # Run portfolio analysis
    print("\nAnalyzing portfolio...")
    from donchian_strategy import analyze_portfolio
    ...
    # Print portfolio results at the end
    print("\nPortfolio Summary:")
